...
describe("To do list test suits", () => {
  beforeAll(() => {
    ...
    add({ title: "mail service", dueDate: today, completed: false });
    add({ title: "admission", dueDate: tomorrow, completed: false });
    add({ title: "going on a date", dueDate: tomorrow, completed: false });
  });
